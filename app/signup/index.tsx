...
// Import constants
import { STATES, getAreasByStateId } from '../../src/constants/stateAreas';
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.roleContainer}>
            ...
            >
              <Text style={[
                styles.roleText,
                userRole === UserRole.WORKER && styles.roleTextActive
              ]}>Worker</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={[
                styles.roleText,
                userRole === UserRole.EMPLOYER && styles.roleTextActive
              ]}>Employer</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={[
                styles.roleText,
                userRole === UserRole.BOTH && styles.roleTextActive
              ]}>Both</Text>
            </TouchableOpacity>
          </View>

          {/* Show job category and description fields only for workers or both */}
